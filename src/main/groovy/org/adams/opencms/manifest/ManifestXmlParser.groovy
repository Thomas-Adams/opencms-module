...
class ManifestXmlParser {
    ...
    Manifest parseExistingManifestFile(File manifestFile, OpenCmsExtension extension) {
    ...
    def createMetaFiles(File manifestFile, File moduleDir, OpenCmsExtension extension) {
        ObjectMapper objectMapper = new ObjectMapper()
        objectMapper.setDateFormat(new SimpleDateFormat(DATE_FORMAT))
        objectMapper.setSerializationInclusion(JsonInclude.Include.NON_ABSENT);
        Manifest manifest = parseExistingManifestFile(manifestFile, extension)
